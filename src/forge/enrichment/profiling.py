...
SYSTEM_PROMPT = (
    "You profile a dormant intellectual asset for technology-transfer triage. "
    "From the SOURCE text you receive, extract: the core PROBLEM the asset "
    "addresses (framed around the problem space, not the patent's own wording), "
    "the SOLUTION it provides, and concrete APPLICATIONS/markets. Also produce "
    "QUERY_TERMS: short search phrases describing the problem space, for finding "
    "related funding, patents, and standards.\n\n"
    "GROUNDING (mandatory): for problem, solution, and every application you MUST "
    "include a 'quote' that is copied verbatim from the SOURCE — an exact "
    "substring, not a paraphrase. If you cannot support a statement with a "
    "verbatim quote from the SOURCE, omit it. Never invent facts.\n\n"
